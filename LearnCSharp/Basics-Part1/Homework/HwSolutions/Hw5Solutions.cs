...
namespace LearnCSharp.Basics_Part1.Homework.HwSolutions
{
    class Hw5Solutions
    {
        ...
        {
            for (int i = 1; i < 10; i++) // change int i = 0 to int i = 1
            {
                Console.WriteLine(i);
            }
        }
        ...
        {
            for (int i = 1; i <= num; i++) // change i++ to i--
            {
                if (i % 3 == 0)
                {
        ...
        public void FillBag(List<string> bag, int numberOfMarblesToFillBag)
        {
            ...
            for (int i = 0; i < numberOfMarblesToFillBag; i++)
            {
                ...
                string color = colors[randomNum]; // change colors[i] to colors[randomNum]
                bag.Add(color);
            }
        }
        ...
        public void Run()
        {
            ...
            switch (operation)
            {
                ...
                case "*":
                    ...
                    break;
                case "/":
                    result = firstNum / secondNum; // change * to /
                    break;
                default:
            ...
            Console.WriteLine($"The solution {firstNum} {operation} {secondNum} = {result}"); // change {firstNum} {operation} {firstNum} to {firstNum} {operation} {secondNum}
            Console.Read();
        ...
        public static List<string> GenerateDeck()
        {
            ...
            foreach (var cardType in cardTypes)
            {
                ...
                {
                    var card = cardValue + " of " + cardType; // change "of" to " of "
                    deck.Add(card); // move this line inside of both foreach loops
                }
            }
            return deck;
        }
